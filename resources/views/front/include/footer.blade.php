                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="footer_widget">
                                ...
                                <ul class="footer-menu">
                                    ...
                                    <li><a href="{{route('about.us')}}" wire:navigate >Course Page</a></li>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12 col-md-12 text-center">
                    <p class="mb-0">© Copyright 2024 BiddaBari <a href="https://biddabari.com/">All Rights Reserved BiddaBari</a>.</p>
                </div>
            </div>
        </div>
    </div>
